...
urlpatterns = [
    ...
    path('<int:etudiant_id>/ajouter-note/', views.ajouter_notes, name='ajouter_note'),
    path('<int:etudiant_id>/supprimer/', views.supprimer_etudiants, name='supprimer_etudiant'),
]